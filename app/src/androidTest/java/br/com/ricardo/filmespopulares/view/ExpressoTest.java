...
public class ExpressoTest {
    ...
    @Rule
    public ActivityTestRule<MovieList> mActivityTestRule = new ActivityTestRule<>(MovieList.class);
    ...
    public void expressoTest() {
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.recycler_movielist),
                        childAtPosition(
                                withId(R.id.swipe_container_movielist),
                                0)));
